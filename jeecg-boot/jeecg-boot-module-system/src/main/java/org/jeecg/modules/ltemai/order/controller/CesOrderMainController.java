package org.jeecg.modules.ltemai.order.controller;
...
import org.jeecg.common.system.query.LtmaiQueryWrapper;
...
import org.jeecg.modules.ltemai.order.vo.CesOrderMainPage;
import org.jeecg.modules.ltemai.order.service.ICesOrderMainService;
...
@Api(tags="商城订单表")
@RestController
@RequestMapping("/order/cesOrderMain")
@Slf4j
public class CesOrderMainController {
	...
	public Result<?> queryPageList(CesOrderMain cesOrderMain,
		...
		LtmaiQueryWrapper<CesOrderMain> ltmaiQueryWrapper = new LtmaiQueryWrapper<>(cesOrderMain);
		ltmaiQueryWrapper.initSubTable("order_main_id", "ces_order_goods");
		ltmaiQueryWrapper.initSubTable("order_main_id", "ces_order_customer");
		QueryWrapper<CesOrderMain> queryWrapper = QueryGenerator.initQueryWrapper(ltmaiQueryWrapper, cesOrderMain, req.getParameterMap());
