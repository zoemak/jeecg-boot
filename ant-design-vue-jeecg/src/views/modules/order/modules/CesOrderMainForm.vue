  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          add: "/order/cesOrderMain/add",
          edit: "/order/cesOrderMain/edit",
          queryById: "/order/cesOrderMain/queryById",
          cesOrderGoods: {
            list: '/order/cesOrderMain/queryCesOrderGoodsByMainId'
          },
          cesOrderCustomer: {
            list: '/order/cesOrderMain/queryCesOrderCustomerByMainId'
          },
        }
      }
    },
